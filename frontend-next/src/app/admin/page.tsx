...
import AdminSessionCacheGuard from "@/components/admin-session-cache-guard";
...
export default function AdminPage(){
  return <><AdminSessionCacheGuard/><ApiWakeGuard/><AdminRuntimeUx/><ImportRecoveryGuard/><CupCreateLauncher/><CupSetupGuide/><PitchWindowImportReview/><PlayoffImportReview/><ImportCompletionSummary/><AdminWorkspace/><AdminOperations/></>;
}
