...
function Side({team,label,away=false}:{team?:Team;label:string;away?:boolean}){
  return <div className={`public-match-team ${away?"public-match-team--away":""}`}>
    <div className="public-match-team__visual">
      ...
      <TeamKit primary={away?team?.secondary_color:team?.primary_color} secondary={away?team?.away_color_2:team?.home_color_2} pattern={away?team?.away_pattern:team?.home_pattern}/>
    </div>
