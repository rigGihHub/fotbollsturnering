  ...
  return (
    <section className="texttv texttv--standings" aria-labelledby={`table-${name}`}>
      ...
      <div className="texttv__scroll">
        <table>
          <thead><tr><th>#</th><th>Lag</th><th>S</th><th>V</th><th>O</th><th>F</th><th><span className="standings-goal-desktop">MS</span><span className="standings-goal-mobile">+/-</span></th><th>P</th></tr></thead>
