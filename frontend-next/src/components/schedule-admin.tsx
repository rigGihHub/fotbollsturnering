...
export default function ScheduleAdmin({token,cupId}:{token:string;cupId:number}){
  ...
  return <section className="admin-panel admin-teams" id="schedule">
    ...
    {data.unscheduled_count===0&&analysis.ok&&<section className="schedule-ready-card"><span className="schedule-ready-card__check">✓</span><div><small>SCHEMAT ÄR KOMPLETT · REDO FÖR GRANSKNING</small><h3>Alla {data.match_count} matcher har tid och plan</h3><p>Inga krockar hittades. Kontrollera särskilt avspark och plan i matchlistan nedan.</p></div><a href="#publish">Jag har granskat – fortsätt →</a></section>}
    ...
    {data.schedule_dirty&&<div className="schedule-save-state"><b>Ändringar är sparade</b><span>Schemat behöver publiceras på nytt för att bli synligt i cupvyn.</span></div>}
