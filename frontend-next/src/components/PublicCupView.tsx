...
export function PublicCupView({ publicKey, initialCup, initialStandings }:{publicKey:string;initialCup:CupSnapshot;initialStandings:StandingsGroup[]}){
  ...
  const navItems:Array<[Tab,string]>=[["matchday","Idag"],["matches","Matcher"],["table","Tabeller"],...(statsEnabled?[["stats","Topplistor"] as [Tab,string]]:[]),["playoff","Slutspel"],["info","Cupinfo"]];
