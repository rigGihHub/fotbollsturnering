...
from .participant_resolution_repository import resolve_public_brackets, resolve_public_snapshot
...
def playoffs(public_key:str):
    ...
    return {"playoff_format":tournament.get("playoff_format"),"brackets":resolve_public_brackets(tournament,brackets)}
