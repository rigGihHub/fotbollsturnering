...
RELEASE="2026.08.25-162-PUBLIC-DESKTOP-DENSITY"
...
def test_follow_team_is_compact_keyed_container():
    assert 'with st.container(key=f"public_follow_{tournament_id}"):' in APP
