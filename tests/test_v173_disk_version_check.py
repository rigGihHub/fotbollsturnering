...
R="2026.08.27-231-ADMIN-PHASE3-E2E-PLAYOFF"
...
def test_public_team_selector_uses_explicit_all_teams_sentinel():
    assert '_all_teams_value = "__all__"' in APP
    assert 'team_id == _all_teams_value' in APP
    assert 'favorite_team_id = None if _favorite_selection == _all_teams_value' in APP
