...
def test_v193_design_system():
 assert "CUPNAVI PRODUCT DESIGN SYSTEM v1.193" in STYLE
 assert "inject_v193_product_design_system()" in APP
def test_tokens():
 for t in ["--cn-color-primary:","--cn-color-secondary:","--cn-color-accent:","--cn-color-bg:","--cn-color-surface:","--cn-color-border:","--cn-color-text:","--cn-color-success:","--cn-color-warning:","--cn-color-error:","--cn-color-info:","--cn-space-1:","--cn-space-8:","--cn-radius-sm:","--cn-radius-lg:"]: assert t in STYLE
