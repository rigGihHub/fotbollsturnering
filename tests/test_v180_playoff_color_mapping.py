...
R="2026.09.07-520-UNIQUE-PUBLICATION-CHECKLIST-KEYS"
...
def test_distinct_row_colors_exist():
    assert ".texttv-table tr.qual-rank-1 td" in PRESENTATION
    assert ".texttv-table tr.qual-rank-2 td" in PRESENTATION
    assert ".texttv-table tr.qual-rank-3 td" in PRESENTATION
    assert ".texttv-table tr.qual-rank-4 td" in PRESENTATION
