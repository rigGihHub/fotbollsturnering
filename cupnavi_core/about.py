...
FEATURE_CATALOG = (
    ...
    {
        "id": "competition_difficulty",
        "category": "organizer",
        "sv_title": "Tävlingsklasser med nivå",
        "en_title": "Competition classes with level",
        "sv": "Tävlingsklasser kan märkas Lätt, Medel, Svår eller Extra svår för tydligare nivåindelning.",
        "en": "Competition classes can be marked Easy, Medium, Hard or Extra hard for clearer level grouping.",
    },
    {
        "id": "daily_venue_windows",
        "category": "organizer",
        "sv_title": "Plantider per dag",
        "en_title": "Daily venue windows",
        "sv": "Start- och sluttid anges per cupdag och används som hårda gränser av schemaläggaren.",
        "en": "Start and end times are defined for each tournament day and enforced by the scheduler.",
    },
    {
        "id": "practical_info",
        "category": "audience",
        "sv_title": "Praktisk cupinformation",
        "en_title": "Practical tournament information",
        "sv": "Omklädningsrum och valbara priser/avgifter kan visas tillsammans med övrig besökarinformation.",
        "en": "Changing-room access and optional prices or fees can be shown alongside other visitor information.",
    },
    {
        "id": "sharing",
        "category": "audience",
