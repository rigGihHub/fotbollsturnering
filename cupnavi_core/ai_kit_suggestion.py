...
def _search_strategies(clean_name, *, location="", country_code="", age_class="", search_hint="", resolved_club="", resolved_source_url="", search_focus="kit", kit_mode="both"):
    ...
    primary = (
        ...
        f"Ta även fram officiell webbplats eller förbundsprofil och {focus}. "
...
def _request_suggestion(clean_name, api_key, *, model, timeout_seconds, strategy_instruction, search_focus, kit_mode="both", opener):
    instructions = (
        ...
        "UNGDOMSLAG: skilj på färgankare och exakt tröjdesign. Klubbens/A-lagets etablerade hemmafärg är stark stödinfo för ungdomslagets grundfärg när direkt ungdomsbevis saknas, men seniorlagets mönster eller säsongsmodell får ALDRIG ensam verifiera ungdomslagets mönster. Prioritera exakt ungdomslags lag-/matchbilder för mönster och avvikelser. Om sådana saknas, sök samma ungdomssektion/åldersgrupp och därefter klubbens gemensamma ungdomsställ. Seniorlaget är sista reserv för färgankare. För bortaställ krävs direktare bevis; anta inte seniorlagets bortaställ. Om färgankaret är starkt men mönstret saknar ungdomsbevis, använd Helfärgad endast som försiktig färgpresentation och skriv tydligt i evidence att mönstret inte är direkt verifierat; sätt inte verified=true enbart på färgankaret. "
