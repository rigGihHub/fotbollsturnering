...
APP_BUILD_VERSION = "2026.08.25-174-CAPACITY-FIRST-SETUP"
...
def render_initial_tournament_setup(tournament_id, tournament):
    ...
    st.caption("Definiera vilka som deltar. Tävlingsformatet föreslås först när CupNavi även känner till plan- och tidskapaciteten.")
