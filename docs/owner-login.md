...
CupNavi supports one environment-only owner credential for creator/emergency access.
...
- removing either owner environment variable invalidates existing owner sessions
